...
- The **Email Templates** tab is where new email templates can be created and saved, as well as where email templates can be edited and updated. Using the *select template to edit* drop down tab, choose the email template you want to edit and then click either *Save Changes* or if you are unhappy with your work, the *Reset to Default* button at the botom. *Days before trip to send this email* can also be adjusted here for each template.  📧
